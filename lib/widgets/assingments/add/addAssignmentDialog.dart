...
import 'package:plannerop/widgets/assingments/components/inChargerSelection.dart';
import 'package:provider/provider.dart';
import 'package:plannerop/widgets/assingments/components/selectWorkers/workerList.dart';
...
// Método para resetear los bloqueos
  ...
  void updateSelectedGroups(List<WorkerGroup> groups) {
    // 1. Guardar los grupos
    setState(() {
      _selectedGroups = groups;
    });

    // 3. Procesar horarios de grupos cuando cambian los grupos
  ...
  Widget build(BuildContext context) {
    ...
    // Calcular el ancho disponible de la pantalla
      ...
      child: Container(
        constraints: BoxConstraints(
          ...
          maxWidth: screenWidth < 600
              ? screenWidth - 32 // En móviles, usar casi toda la pantalla
              : screenWidth * 0.8,
        ),
            ...
            children: [
              ...
              AssignmentForm(
                ...
                onProgrammingSelected: (programming) {
                  // Almacenar la programación y su ID
                  setState(() {
                    _selectedProgramming = programming;

                    // IMPORTANTE: También actualizar el texto del controller
                    // para que el valor persista cuando se envíe el formulario
                    if (programming != null) {
                    ...
                    // Debug para verificar que se está asignando correctamente
                    debugPrint(
