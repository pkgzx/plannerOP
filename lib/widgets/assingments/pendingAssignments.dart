              ...
              child: Row(
                children: [
                  ...
                  NeumorphicButton(
                    ...
                    onPressed: () {
                      _showGroupCompletionDialog(context, assignment, workers,
                          groupId, assignmentsProvider);
                    },
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: const [
          ...
          children: [
            ...
            if (!isDeleted && !isInGroup)
              NeumorphicButton(
                ...
                onPressed: () {
                  _showIndividualCompletionDialog(
...
// Diálogo para confirmar la finalización de un grupo de trabajadores
  void _showGroupCompletionDialog(BuildContext context, Assignment assignment,
      List<Worker> workers, String groupId, AssignmentsProvider provider) {
...
// Diálogo para confirmar la finalización de un único trabajador
  void _showIndividualCompletionDialog(BuildContext context,
      Assignment assignment, Worker worker, AssignmentsProvider provider) {
    bool isProcessing = false;
    DateTime selectedDate = DateTime.now();
    TimeOfDay selectedTime = TimeOfDay.now();
                  ...
                  onPressed: isProcessing
                      ...
                      : () async {
                          ...
                          try {
                            ...
                            debugPrint(
                                'Error al completar tarea individual: $e');
