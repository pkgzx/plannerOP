...
// También corrige este método para que considere correctamente los trabajadores seleccionados:
                                ...
                                Row(
                                  children: [
                                    Container(
                                      ...
                                      height: 8,
                                      decoration: BoxDecoration(
                                        color: _getColorForArea(worker.area),
                                        shape: BoxShape.circle,
                                      ),
                                    ),
  ...
  // Obtener color para un área
  Color _getColorForArea(String area) {
    // Hash simple para obtener un color consistente
    ...
    for (int i = 0; i < area.length; i++) {
      hash = area.codeUnitAt(i) + ((hash << 5) - hash);
    }
